...
public class LikeUsOnFacebookActivity extends DrawerActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		View contentView = inflater.inflate(R.layout.checklist_activity, null,
				false);
	...
	void initlizeUIElement(View contentView) {
		...
		textViewSubHeaderTitle.setText("Like Us on Facebook");
