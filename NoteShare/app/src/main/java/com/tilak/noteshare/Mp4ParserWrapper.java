...
public class Mp4ParserWrapper {
	...
	/**
	 * Appends mp4 audios/videos: {@code anotherFileName} to
	 * {@code mainFileName}.
	 */
	...
	public static void append(final String firstFile, final String secondFile,
			final String newFile) throws IOException {

		com.googlecode.mp4parser.authoring.Movie movieA = MovieCreator
				.build(new FileDataSourceImpl(secondFile));

		;
		com.googlecode.mp4parser.authoring.Movie movieB = MovieCreator
				.build(new FileDataSourceImpl(firstFile));

		final com.googlecode.mp4parser.authoring.Movie finalMovie = new com.googlecode.mp4parser.authoring.Movie();
